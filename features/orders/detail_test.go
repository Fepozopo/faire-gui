...
func TestPresentDetailMapsApprovedNestedOrderData(t *testing.T) {
	...
	if detail.Notes != "Leave at desk" || detail.OriginalOrderID != originalOrderID || detail.OriginalOrderDisplayID != "ORIGINAL-ORDER-1" || detail.ShipAfter != localDate(t, shipAfter) || detail.RequestedShipDate != localDate(t, requestedShipDate) || detail.ExpectedShipDate != localDate(t, expectedShipDate) || detail.SalesRepName != "Grace Hopper" || detail.IsFreeShipping != "Yes" || detail.FreeShippingReason != "Free Shipping Threshold" || detail.UpdatedAt != "2026-01-03 04:05 UTC" || detail.SyncedAt != "2026-01-04 05:06 UTC" {
