...
func TestPresentDetailMapsApprovedNestedOrderData(t *testing.T) {
	...
	if detail.OrderID != orderID || detail.DisplayID != displayID || detail.Status != "Processing" || detail.Customer != "Ada Lovelace" || detail.Commission != "$2.50" || detail.TotalPayout != "$9.99" {
